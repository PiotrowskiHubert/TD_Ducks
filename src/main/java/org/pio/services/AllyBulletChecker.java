...
public class AllyBulletChecker {

    public static void checkIfAllyBulletHitEnemy(List<Ally> allies, List<Enemy> enemies, Level level){
        goThroughAllies(allies, enemies, level);
    }

    private static void goThroughAllies(List<Ally> allies, List<Enemy> enemies, Level level) {
        for(Iterator<Ally> allyIterator = allies.iterator(); allyIterator.hasNext();){
            ...
            for(Iterator<Bullet> bulletIterator = nextAlly.bulletList.iterator(); bulletIterator.hasNext();){
                ...
                for(Iterator<Enemy> enemyIterator = enemies.iterator(); enemyIterator.hasNext();){
                    ...
                    if(nextBullet.getBulletHitBox().intersects(nextEnemy.bounds.getBounds())){
